...
const Guide = () => {
  return (
    <section id="guides" className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        <Image src="/camp.svg" alt="camp" width={50} height={50} />
        <p className="uppercase regular-18  -mt-1 mb-3 text-green-50">We are here for you</p>
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          <h2 className="bold-40 lg:bold-64 xl:max-2-[390px]">Guide You to Easy Path</h2>
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Aguas Calintes</p>
            </div>
            <div className="flex w-full flex-col">
